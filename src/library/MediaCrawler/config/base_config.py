...
# 基础配置
PLATFORM = "xhs"
# KEYWORDS = "编程副业,编程兼职"  # 关键词搜索配置，以【英文】逗号分隔 
KEYWORDS = "肇庆旅游" #云南旅游 //逗号不能是中文！！！，,
LOGIN_TYPE = "qrcode"  # qrcode or phone or cookie
COOKIES = ""
# 具体值参见media_platform.xxx.field下的枚举值，暂时只支持小红书
SORT_TYPE = "popularity_descending"
# 具体值参见media_platform.xxx.field下的枚举值，暂时只支持抖音
ACCESS_TOKEN_OCR_BAIDU = "24.9c9cdaf67ab3876256df49e508eb4725.2592000.1748101086.282335-118646300"
# access_token请网页搜索参考百度智能云OCR API利用api_key和secret_key获取access_token的方法
PUBLISH_TIME_TYPE = 0
CRAWLER_TYPE = (
...
STOP_WORDS_FILE = os.path.join(os.path.dirname(current_dir), "docs", "hit_stopwords.txt")

# 中文字体文件路径
# FONT_PATH = "./docs/STZHONGS.TTF"
FONT_PATH = os.path.join(os.path.dirname(current_dir), "docs", "STZHONGS.TTF")
