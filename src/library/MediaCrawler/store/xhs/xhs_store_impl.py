...
class XhsJsonStoreImplement(AbstractStore):
    ...
    json_store_path: str = os.path.join(media_crawler_dir, r"data\xhs\json")
    print("json_store_path",json_store_path)
    # words_store_path: str = "data/xhs/words"
    words_store_path: str = os.path.join(media_crawler_dir, r"data\xhs\words")
    lock = asyncio.Lock()
    ...
    def make_save_file_name(self, store_type: str) -> (str,str):
        ...
        """
        # e.g, search_comments_2025-04-24.json
        return (                     
