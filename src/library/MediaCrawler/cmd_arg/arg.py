...
async def parse_cmd():
    ...
    parser.add_argument('--access_token', type=str,
                        help='access_token of OCR API generated by BAIDU api-key and secret-key', default=config.ACCESS_TOKEN_OCR_BAIDU)
    parser.add_argument('--use_ocr', type=str,
                        help='Flag of whether using api to read texts from image or not', default=config.USE_OCR)
    ...
    config.ACCESS_TOKEN_OCR_BAIDU = args.access_token
    config.USE_OCR = args.use_ocr
